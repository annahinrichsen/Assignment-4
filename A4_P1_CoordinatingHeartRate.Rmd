...
#random sample of surrogate_df
surrogate_sample_df = surrogate_df[sample(nrow(surrogate_df), 22),]
...
surrogate_final_df = rbind(final_df, surrogate_sample_df)
...
#model respiration coordination
model_resp_L <- lm(resp_L~typePairs, data = surrogate_final_df)
